...
@section('content')
        ...
        <div class="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6 ">
            <div class="grid gap-8 mb-6 lg:mb-10 md:grid-cols-2">
                ...
                <div
                    class="items-center border border-gray-200 rounded-lg shadow sm:flex dark:bg-gray-800 dark:border-gray-700">
                    <div class="p-5 mx-auto">
                        @if (!empty($order->postage))
                            <h3 class="text-3xl font-bold tracking-tight text-gray-900 dark:text-white">
                                Total Bayar : Rp. {{ number_format($order->remaining_payment + $order->postage) }}
                            </h3>
                        @endif
                    </div>
                </div>
                ...
                <div
                    ...
                    <div class="p-5">
                        ...
                        <span class="text-gray-500 dark:text-gray-400 mt-4 text-lg">330222111</span>
                    </div>
                </div> --}}
            </div>
            <div
            ...
            <div class="mx-auto max-w-screen-md text-center mb-8 lg:mb-16">
                <form action="/order/evidencetf2/{{ $order->id }}" method="post" enctype="multipart/form-data">
                    @method('put')
                    @csrf
                    <div class="mb-7 w-96 mx-auto">
                        ...
                        @if ($order->evidencetf2)
                            <img src="{{ asset('storage/' . $order->evidencetf2) }}" class="mb-3 img-fluid col-sm-5">
                        @else
                            <img class="mb-3 img-preview img-fluid col-sm-5">
                        @endif
                        <img class="mb-3 img-preview img-fluid w-20 col-sm-5">
                        <input name="evidencetf2" id="evidencetf2" onchange="previewImage()"
                            @error('evidencetf2') is-invalid @enderror
    ...
    <script>
        ...
        function previewImage() {
            const image = document.querySelector('#evidencetf2'); //mengambil selector id
